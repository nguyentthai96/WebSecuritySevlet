                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="dropdown navbar-form navbar-right">
                                            <button class="btn btn-default dropdown-toggle textcolor"
                                                    style="background: #0c6b63;" type="button" id="dropdownMenu1"
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                ...
                                                <li><a href="chuyentrang.jsp"><c:out
                                                        value="${sessionScope['phanquyen']}"/></a></li>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form id="FormTimKiemNangCao" method="post" class="form-horizontal"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-4 control-label" for="TimKiemTheo">Tìm
                                                                    Kiếm Theo Tác Giả: </label>
                                                                <div class="col-sm-5">
                                                                    <select class="form-control" name="key">
                                                                        <c:forEach var="row1" items="${result.rows }">
                                                                            <option value="${row1.username_taikhoan }">
                                                                                <c:out value="${row1.tentacgia }"/></option>
                                                                        </c:forEach>
                                                                    </select>
                                                                </div>
                                                            </div>
                                ...
                                <nav class="navbar navbar-default" style="background: #0c6b63;">
                                    ...
                                    <div class="navbar-collapse collapse" id="main-menu">
                                        <ul class="nav nav-justified ">
                                            <li><a class="textcolor" href="trangchu.jsp"><strong>Trang chủ</strong></a>
                                            </li>
                                            <li><a class="textcolor" href="" id="GioiThieu"><strong>Giới Thiệu</strong></a>
                                            </li>
                                            <li><a class="textcolor" href="" id="QDHD"><strong>Quy Định-Hướng
                                                Dẫn</strong></a></li>
                                            <li><a class="textcolor" href="" id="LienHe"><strong>Liên Hệ</strong></a>
                                            </li>
                                            <li><a class="textcolor" href="" id="LienKet"><strong>Liên Kết</strong></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="panel">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item" data-id="journal1673">
                                            <a href="#" class="list-group-item"><strong>Khoa học xã hội và nhân
                                                văn</strong></a>
                                                    ...
                                                    <c:forEach var="row" items="${result.rows}">
                                                        <tr>
                                                            ...
                                                            <td><a class="glyphicon glyphicon-edit"
                                                                   href="updatetk.jsp?id=<c:out value="${row.id}"/>"/>
                                                            </td>
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <c:forEach var="row" items="${result.rows}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="updatett.jsp?id=<c:out value="${row.id}"/>">Sửa</a>
                                                            </td>
