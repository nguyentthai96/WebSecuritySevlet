                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="nav navbar col-md-push-6">
                                    <button class="btn btn-default textcolor" style="background: #0c6b63;"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="FormDangNhap" method="post" action="loginAuthenticate.jsp"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="username_signin">User
                                                                Name </label>
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control"
                                                                       id="username_signin" name="uname"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="password" class="form-control"
                                                                       id="password_signin" name="pass"
                                                                       placeholder="Password"/>
                                                            </div>
                                                        </div>

                                                        <div class="modal-footer modal-footer-left">
                                                            <input type="submit" class="btn btn-primary col-md-offset-5"
                                                                   role="button" value="Đăng Nhập"/>
                                    ...
                                    <div class="modal fade" id="myModal1" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <!--body-->
                                                <div class="modal-body">
                                                    <form id="FormDangKy" method="post" class="form-horizontal"
                                                          action="">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="confirm">Confirm
                                                                PassWord </label>
                                                            <div class="col-sm-5">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-9 col-sm-offset-2">
                                                                <button type="submit"
                                                                        ...
                                                                        name="signup1" value="Sign up">Đăng Ký
                                                                </button>
                                                            </div>
                                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <form class="navbar-form navbar-right" role="search" method="post"
                                      action="xulytimkiem.jsp">
                                    <div class="form-group">
                                        <input type="text" name="key" value="" class="form-control"
                                               placeholder="Nhập từ khóa tìm kiếm...">
                                    </div>
                                    <button type="submit" class="btn btn-primary textcolor"
                                            style="background: #0c6b63;">TÌM
                                    </button>
                                </form>
                                <!--Ajax-->
                                <script type="text/javascript">
                                ...
                                <div class="modal fade" id="myModal3" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form id="FormTimKiemNangCao" method="post" class="form-horizontal"
                                                  action="xulytimkiem.jsp">
                                                <div class="modal-body">

                                                    <sql:setDataSource var="dataSource" driver="com.mysql.jdbc.Driver"
                                                                       url="${sessionScope['url']}"
                                                                       user="${sessionScope['userdb']}"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label" for="TimKiemTheo">Tìm Kiếm
                                                            Theo Tác Giả: </label>
                                                        <div class="col-sm-5">
                                                            <select class="form-control" name="key">
                                                                <c:forEach var="row1" items="${result.rows }">
                                                                    <option value="${row1.username_taikhoan }"><c:out
                                                                            value="${row1.tentacgia }"/></option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label" for="ThoiGian">Thời
                                                            Gian: </label>
                                                        <div class="col-sm-5">
                                                            <select class="form-control" name="date">
                                                                <c:forEach var="row2" items="${result2.rows }">
                                                                    <option value="${row2.NgayDang }"><c:out
                                                                            value="${row2.NgayDang }"/></option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                        ...
                        <nav class="navbar navbar-default" style="background: #0c6b63;">
                            ...
                            <div class="navbar-collapse collapse" id="main-menu">
                                <ul class="nav nav-justified ">
                                    ...
                                    <li><a class="textcolor" href="" id="QDHD"><strong>Quy Định-Hướng Dẫn</strong></a>
                                    </li>
            ...
            <div id="Main">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="panel">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item" data-id="journal1672">
                                    <a href="" class="list-group-item"><strong>Khoa học tự nhiên và công
                                        nghệ</strong></a>
                        ...
                        <!--quang cao-->
                        <p style=" ">
                            <embed height="210" width="180" type="application/x-shockwave-flash"
                                   allowscriptaccess="always" wmode="transparent" allowfullscreen="false"
                                   scale="noborder" quality="high" src="Flash/135.swf" title=" "/>
                        </p>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <sql:setDataSource var="dataSource" driver="com.mysql.jdbc.Driver"
                                                   ...
                                                   password="${sessionScope['passdb']}"/>
                                <%-- NTT TODO fixed injection sql 01 --%>
                                ...
                                <sql:query dataSource="${dataSource}" var="rs">
                                    ...
                                    Where ds_baiviet_dagui.ID_baiviet_dagui=ds_baiviet_bientap.ID_baiviet_dagui
                                    and ds_baiviet_bientap.ID_baiviet_bientap=ds_noidung_bientap.ID_baiviet_bientap
                                    and ID_noidung_bientap='<c:out value="${param.id}"/>' <%-- NTT TODO c:out escapes HTML characters so that you can avoid cross-site scripting.--%>
                                </sql:query>
                                <%-- \NTT TODO fixed injection sql 01 --%>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-md-offset-1">
                                            ...
                                            <div class="thumbnail aa">
                                                <div class="thumbnail">
                                                    <img src="GetAnhBT?id_bt=${row.ID_noidung_bientap }"
                                                         style="border-width:1px;height:170px;width:155px;">
                                                </div>
                                                <Center>
                                                    <div class="caption">
                                                        <a href="Read_TBT?id=${param.id } " target="_blank"
                                                           class="btn btn-info" role="button">Xem</a>
                                                        <a href="DownloadFile_BTV?id=${param.id }"
                                        ...
                                        <div class="col-md-offset-6">
                                            <p><font color="green"><Strong>Tiêu đề:</Strong></font> <c:out
                                                    value="${row.tieude_bientap}"/></p>
                                            <p><font color="green"><Strong>Ngày đăng:</Strong></font> <c:out
                                                    value="${row.NgayDang }"/></p>
                                            <p><font color="green"><Strong>Tác Giả:</Strong></font> <c:out
                                                    value="${row.tentacgia }"/></p>
                                            <p><font color="green"><Strong>Lĩnh vực:</Strong></font> <c:out
                                                    value="${row.danhmuc }"/></p>

                                            <p><font color="green"><Strong>Tóm tắt:</Strong></font> <c:out
                                                    value="${row.noidung_bientap}"/></p>
                                        </div>
                                    </div>
                                </c:forEach>
                                <br>
                                ...
                                <form action="insert_comment.jsp" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="noidung_comment" rows="5"
                                ...
                                <br>
                                <div class="col-sm-offset-2">
                                    <font color='green'><%=request.getAttribute("Messagess")%>
                                    </font>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <marquee scrolldelay="6" scrollamount="2" onmouseover="this.stop()"
                                " onmouseout="this.start()" direction="up" height="300" style="height:300px;"
                                behavior="" direction="">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading"><a
                                                    href="xulyxembai.jsp?id=${rows.ID_baiviet }"><c:out
                                                    value="${rows.tieude_bientap}"/></a></h5>
